...
export default function Nineteen84() {
  return (
    <View style={styles.container}>
      <ScrollView><TextInput multiline editable={false}>
      ...
      *****
      ...
      <Text style={styles.destruct}>Text will self-destruct without warning</Text>
    </View>
  );
}
